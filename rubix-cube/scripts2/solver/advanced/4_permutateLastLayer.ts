...
function applyAlgorithm(cube: RubixCube) {
   ...
   for (let i = 0; i < 4; i++) {
      ...
      // edges only
      {
         executeOnMatch(cube, [or, re, or, bl, gr, bl, re, or, re, gr, bl, gr], [M, M, U, M, M, U, U, M, M, U, M, M]);
      ...
      // Corners only
      {
         ...
         executeOnMatch(cube, [re, or, or, bl, bl, re, gr, re, gr, or, gr, bl], [R, R, B, B, R, F, R_, B, B, R, F_, R]);
